...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'django_filters',
    # Custom Apps - App-based Architecture
    'apps.organization',
    'apps.accounts',
    'apps.attendance',
    'apps.allowance',
...
ROOT_URLCONF = 'traveling_allowance.urls'
...
WSGI_APPLICATION = 'traveling_allowance.wsgi.application'

# Database Configuration
# https://docs.djangoproject.com/en/5.0/ref/settings/#databases

# Determine database engine - defaults to SQLite for development
